...
export const mockTasks: EmployeeTask[] = [
  {
    id: 'task-1',
    name: 'בדיקת מודעות חדשות',
    description: 'לעבור על כל המודעות שממתינות לאישור ולבדוק תקינות המסמכים.',
    user: 'יהושע',
    status: 'todo',
    active: true,
    files: [],
  ...
  {
    id: 'task-2',
    name: 'טיפול בסכסוך הזמנה #0002',
    description: 'ליצור קשר עם הקונה והמוכר ולבדוק את פרטי העסקה.',
    user: 'אלעד',
    status: 'todo',
    active: true,
    files: [],
  ...
  {
    id: 'task-3',
    name: 'עדכון תנאי שימוש',
    description: 'לעדכן את דף תנאי השימוש בהתאם לדרישות החדשות מהיועץ המשפטי.',
    user: 'יחיאל',
    status: 'done',
    active: true,
    files: [],
  ...
  {
    id: 'task-4',
    name: 'הוספת אירועי קיץ',
    description: 'להוסיף את כל אירועי הקיץ החדשים למערכת: פסטיבלים, הופעות, ספורט.',
    user: 'יחיאל',
    status: 'todo',
    active: true,
    files: [],
  ...
  {
    id: 'task-5',
    name: 'בדיקת תשלומים תקועים',
    description: 'לבדוק את כל התשלומים בסטטוס "מוחזק" ולוודא שאין בעיות.',
    user: 'אלעד',
    status: 'canceled',
    active: true,
    files: [],
